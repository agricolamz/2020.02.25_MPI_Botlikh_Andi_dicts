...
botlikh_analyse %>% 
  ...
  botlikh1
ggsave(filename = "images/04_compare_botlikh_dicts_with_stress.png", botlikh1, device = "png")
```

![](images/04_compare_botlikh_dicts_with_stress.png)
...
botlikh_analyse %>% 
  ...
  labs(x = "Number of utterances in [Alekseev, Azaev 2019] (log scale)",
       y = "Number of utterances in [Saidova, Abusov 2012] (log scale)") ->
  botlikh2
ggsave(filename = "images/05_compare_botlikh_dicts_without_stress.png", botlikh2, device = "png")
```

![](images/05_compare_botlikh_dicts_without_stress.png)
...
merged_data %>% 
  ...
  zilo1
ggsave(filename = "images/06_compare_botlikh_zilo.png", zilo1, device = "png")
```

![](images/06_compare_botlikh_zilo.png)
...
merged_data %>% 
  ...
  theme(legend.title = element_blank()) ->
  zilo2
ggsave(filename = "images/07_compare_botlikh_zilo.png", zilo2, device = "png")
```

![](images/07_compare_botlikh_zilo.png)
...
visualise_simplified %>%
  ...
  syllables
ggsave(filename = "images/08_syllables.png", syllables, device = "png")
```

![](images/08_syllables.png)
